...
import com.example.cslabposco.WifiMap_RSSI

private val WEB_ADDRESS = "file:///android_asset/HanaSquare_map_for_result.html"//"file:///android_asset/poscocenter-trace.html" //"file:///android_asset/SeoulStation.html"
...
class MainActivity : AppCompatActivity(), SensorEventListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        readwifihashmapFile = resources.openRawResource(R.raw.hanasquare_wifihashmap)
        readwifilistFile = resources.openRawResource(R.raw.hanasquare_wifilist)
        readwifitestFile = resources.openRawResource(R.raw.wifitest)
        readwifirssihashmapFile = resources.openRawResource(R.raw.hanasquare_wifirssihashmap)
        ...
        val mainMap = resources.openRawResource(R.raw.hanasquare_hand)
        val subMap = resources.openRawResource(R.raw.hanasquare_hand_for_instant_3)
        ...
        indoorLocalization = ExIndoorLocalization(mainMap_obj, subMap_obj, resources.openRawResource(R.raw.build_map),
            readwifihashmapFile, readwifirssihashmapFile, readwifilistFile)
...
//                }
    ...
    private fun getWifiInfo(){
        if (wifipermitted) { // wifiScan을 한 경우에만 getScanResult를 사용하도록 flag 변수 구현
            ...
            Log.d("rangeval1", scanResultList.toString())

            indoorLocalization.wifidata = updatedata
            ...
            if(firstwifiscan) {
                ...
                firstwifiscan = false
                wifidataready = true
                indoorLocalization.wifi_ready = true
            } else{
