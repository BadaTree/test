...
class WifiMap constructor(inputStreamTotal: InputStream, inputStreamunq: InputStream, inputStreamtest: InputStream) {
    ...
    fun vectorcompare(range_thres: Int, wifi_string: String) : ArrayList<Int> {
