...
class MainActivity : AppCompatActivity(), SensorEventListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        exIndoorLocalization = ExIndoorLocalization(resources.openRawResource(R.raw.anam_hashmap),
                                                    resources.openRawResource(R.raw.hanahandhashmap_for_instant_3),
                                                    resources.openRawResource(R.raw.anam_wifihashmap_1),
                                                    resources.openRawResource(R.raw.hanasquare_wifirssihashmap),
                                                    resources.openRawResource(R.raw.anam_wifilist_1))
        btnB1.setOnClickListener {
            wvLayout0401v3.loadUrl("javascript:changeMapB1()")
            exIndoorLocalization.setClass(resources.openRawResource(R.raw.anam_hashmap),
                resources.openRawResource(R.raw.hanahandhashmap_for_instant_3),
                resources.openRawResource(R.raw.anam_wifihashmap_1),
                resources.openRawResource(R.raw.hanasquare_wifirssihashmap),
                resources.openRawResource(R.raw.anam_wifilist_1))
        ...
        btnB2.setOnClickListener {
            ...
            exIndoorLocalization.setClass(resources.openRawResource(R.raw.anam_hashmap),
                resources.openRawResource(R.raw.hanahandhashmap_for_instant_3),
                resources.openRawResource(R.raw.anam_wifihashmap_2),
                resources.openRawResource(R.raw.hanasquare_wifirssihashmap),
                resources.openRawResource(R.raw.anam_wifilist_2))
        }
        btnB3_bo.setOnClickListener {
            wvLayout0401v3.loadUrl("javascript:changeMapB3_bo()")
            exIndoorLocalization.setClass(resources.openRawResource(R.raw.anam_hashmap),
                resources.openRawResource(R.raw.hanahandhashmap_for_instant_3),
                resources.openRawResource(R.raw.anam_wifihashmap_3),
                resources.openRawResource(R.raw.hanasquare_wifirssihashmap),
                resources.openRawResource(R.raw.anam_wifilist_3))
        }
        btnB3_ko.setOnClickListener {
            wvLayout0401v3.loadUrl("javascript:changeMapB3_ko()")
            exIndoorLocalization.setClass(resources.openRawResource(R.raw.anam_hashmap),
                resources.openRawResource(R.raw.hanahandhashmap_for_instant_3),
                resources.openRawResource(R.raw.anam_wifihashmap_4),
                resources.openRawResource(R.raw.hanasquare_wifirssihashmap),
                resources.openRawResource(R.raw.anam_wifilist_4))
        }
...
//            exIndoorLocalization.serverReset(myUUID)
    ...
    private fun initUI() {
        ...
        wvLayout0401v3.addJavascriptInterface(WebAppInterface(this), "Android")
        wvLayout0401v3.settings.javaScriptEnabled = true
