...
internal class MovingFloor {
    ...
    internal fun getCondition(movingType : String, startFloor : Int , front :  Boolean) {
        ...
        if(!useMag) {
            if (movingType == "EL1" || movingType == "EL2" || movingType == "EL3" || movingType == "EL4" || movingType == "EL1Front" || movingType == "EL2Front" ) {
                lightElvModule = LightElv(startFloor , front)
                elvType = true
            }
            if(movingType == "Es1") {
