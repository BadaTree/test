        ...
        buildingInfoFileStream.bufferedReader().useLines { lines -> lines.forEach {
            ...
            infoData.add(
                BuilInfo(splitData[0],
                    when(splitData[0]) {
                        "EL1", "EL2", "EL3", "EL4","ST","EL1Front","EL2Front","EL2Front2","EL3Front","EL3Front2","EL3Front3","EL4Front","EL4Front2" -> arrayOf(splitData[1].toDouble(), splitData[2].toDouble(), splitData[3].toDouble(), splitData[4].toDouble())
                        else -> arrayOf() },
                    when(splitData[0]) {
                        "EL1", "EL2", "EL3", "EL4","ST","EL1Front","EL2Front","EL2Front2","EL3Front","EL3Front2","EL3Front3","EL4Front","EL4Front2"  -> arrayOf(splitData[5].toDouble(), splitData[6].toDouble())
                        else -> null
                    },
                    when(splitData[0]) {
                        "EL1", "EL2", "EL3", "EL4","ST","EL1Front","EL2Front","EL2Front2","EL3Front","EL3Front2","EL3Front3","EL4Front","EL4Front2"  -> arrayOf(splitData[7].toDouble(), splitData[8].toDouble())
                        else -> null
                    }
                )
            )
