...
//            coverLayout.visibility = isCoverVisible
    ...
    private fun simulationStart(){

        var result = exIndoorLocalization.sensorChanged()
        when (result[1]) {
            "완전 수렴" -> {
                Log.d("완전수렴", "완전수렴")
        ...
        range.text = "x:"+areaCheckRange[0].toString() +" y:"+ areaCheckRange[1].toString() +" x:"+ areaCheckRange[2].toString() +" y:"+ areaCheckRange[3].toString()
